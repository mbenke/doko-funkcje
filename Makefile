...
funkcje.pdf: funkcje.md Makefile
	pandoc -t beamer --latex-engine=xelatex -V theme:Boadilla  funkcje.md -o funkcje.pdf 
...
#  pandoc -t beamer -s --latex-engine=xelatex -V theme:m  funkcje.md -V colortheme:darksol -o funkcje.pdf 
	pandoc -t beamer --latex-engine=xelatex -V theme:m  funkcje.md $(COLOR) -o funkcje.pdf 
